            ...
            <el-table-column label="操作" width="200" align="center">
                <template slot-scope="scope">
                    <router-link :to="'/user/userinfo/show/' + scope.row.id">
                        <el-button type="primary" icon="el-icon-view" plain size="mini">查看</el-button>
                    </router-link> 
                    <el-button v-if="scope.row.status == 1" type="danger" icon="el-icon-lock" plain size="mini"
                     @click="lock(scope.row.id, 0)">锁定</el-button>
                    <el-button v-if="scope.row.status == 0" type="success" icon="el-icon-lock" plain size="mini"
