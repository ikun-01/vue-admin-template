        ...
        stripe
            ...
            <el-table-column label="操作" width="250" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button type="success" plain icon="el-icon-circle-check" size="mini" @click="approval(scope.row.id, 2)">通过</el-button>
                    <el-button type="danger" plain icon="el-icon-circle-close" size="mini" @click="approval(scope.row.id, -1)">不通过</el-button>
                </template>
            </el-table-column>
        </el-table>
